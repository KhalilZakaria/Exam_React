...
import {data} from '__data/data.js';
 ...
 renderFlatListItem(item){
     ...
     <View style={{borderWidth:1, flexDirection:'row'}}>
       <View style={{flex:2}}>
         ...
         <TouchableOpacity  style={[styles.buttonSuppStyle, {flex:1}]} onPress={()=>this.deleteItem(item.item.key)}><Text style={{color:'white'}}>Supprimer</Text></TouchableOpacity>
     </View>
     )
 }
